<?php require_once('../controller/party_be.php');
    session_start();
    $section = array();
    for ($i = 1; $i <= 4; $i ++){
        $section[$i] = select_party($i);
...
<body>
    ...
    <section id="section_1">
        <div>
          <img src="images/party/<?php echo $image[1][0]; ?>">
        </div>
    </section>
    <section id="section_2" class="container">
        <div> 
          <h1><?php echo $title[2][0]; ?></h1>
          <img src="images/party/<?php echo $image[2][0]; ?>" >
    ...
    <section id="section_3">
        ...
        <section id="section_3_1" class="container"> 
            <div class="row container-fluid">
                <div class=' container-fluid hover01 col-6'  style='position: relative;'>
                    <figure><img src="images/party/<?php echo $image[3][0]; ?>"></figure>
                  </div>
                <div class="col-6">
        ...
        <section id="section_3_2" class="container">
            <div class="row container-fluid">
                ...
                <div class=' container-fluid hover01 col-6'  style='position: relative;'>
                    <figure><img src="images/party/<?php echo $image[3][1]; ?>"></figure>
                  </div>   
            </div>
        </section>
        <div id="clear"></div>
        <section id="section_3_3" class="container">
            <div class="row container-fluid">
                <div class=' container-fluid hover01 col-6'  style='position: relative;'>
                    <figure><img src="images/party/<?php echo $image[3][2]; ?>"></figure>
                  </div>
                <div class="col-6">
