<?php require_once('../controller/wedding_be.php');
    session_start();
    $section = array();
    for ($i = 1; $i <= 5; $i ++){
        $section[$i] = select_wedding($i);
...
<body>
  ...
  <main>
    <section id="section_1">
        <div>
          <img src="images/wedding/<?php echo $image[1][0]; ?>" >
        </div>
      </section>
      <section id="section_2" class="container">
        <div> 
          <h1><?php echo $title[2][0]; ?></h1>
          <img src="images/wedding/<?php echo $image[2][0]; ?>" >
    ...
    <section id="section_3" class="container">
      <section id="section_3_1">
        <div class=' container-fluid hover01'  style='position: relative;'>
          <figure><img src="images/wedding/<?php echo $image[3][0]; ?>"></figure>
        </div>        
      </section>
      ...
      <div id="carousel-intro" class="carousel slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="images/wedding/<?php echo $image[4][0]; ?>" class="d-block w-100"  >
            </div>
            <div class="carousel-item">
              <img src="images/wedding/<?php echo $image[4][1]; ?>" class="d-block w-100"  >
            </div>
            <div class="carousel-item">
              <img src="images/wedding/<?php echo $image[4][2]; ?>" class="d-block w-100 " >
            </div>
          </div>
        ...
        for($k=0;$k<count($image[5]); $k ++){
          echo "
            <div class='col-4 container-fluid hover01'  style='position: relative;'>
              <figure><img src='images/wedding/{$image[5][$k]}'></figure>
            </div>
          ";
        }
      ?>
